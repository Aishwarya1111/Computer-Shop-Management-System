...
case 2 : { system("color 4E"); acc=Access(); if(acc==1) Adminpermit(); else
{getch(); main();}}
default : { comptag(0); system("color B1"); puts("\n\n\n\n\n\n\t\t\t\tTHANK
YOU"); puts("\n\t\tFOR CHOOSING ADISH SOLUTIONS"); fclose(fptr); getch();
exit(0);}
}
}
void Adminpermit(){
case 1 : { PCPurchase(); break;}
case 2 : { system("color 4E"); acc=Access(); if(acc==1) Adminpermit(); else {getch();
main();}}
default : { comptag(0); system("color B1"); puts("\n\n\n\n\n\n\t\t\t\tTHANK
YOU"); puts("\n\t\tFOR CHOOSING ADISH SOLUTIONS"); fclose(fptr); getch();
exit(0);}
...
while(fread(&PC,sizeof(PC),1,fptr)==1)
{
printf("\n\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xC
D\xCD\xCD\xCD");
printf("\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\x
CD\xCD\xCD");
...
ADMINPANEL();
FILE *tptr;
printf("\n\t\t ***** Current selection: Deletion of existing laptop models that are out of
stock *****");
char id[30]; int a=0;
char another='y';
while(another=='y' || another=='Y')
...
scanf("%s",&admin);
if(strcmpi(admin,"aish")==0 || strcmpi(admin,"xyz")==0 || strcmpi(admin,"abc")==0)
...
puts("\n\t\tFOR CHOOSING ADISH SOLUTIONS"); fclose(fptr); getch(); exit(0);}
}
